...
class __TwigTemplate_93c37da17939e9f9585057bb8f32cff85abd274bcfe9c49cd5089db805a54801 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"d-flex flex-column min-vh-100\" style=\"padding-top=100px;\">
    ...
    <form method=\"POST\" action=\"";
       ...
       <select v-for=\"(player, index) in nbPlayers\"  :name=\"'joueur'+index\" class=\"form-select\" aria-label=\"Default select example\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["contents"]) || array_key_exists("contents", $context) ? $context["contents"] : (function () { throw new RuntimeError('Variable "contents" does not exist.', 26, $this->source); })()));
